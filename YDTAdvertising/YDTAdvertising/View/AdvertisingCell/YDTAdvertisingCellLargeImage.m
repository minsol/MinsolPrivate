//
// YDTAdvertisingCellLargeImage.m
//  A8TV_IPhone
//
...
@implementation YDTAdvertisingCellLargeImage

#pragma mark - Life cycle

#pragma mark - Config views
- (void)loadSubviews {
    self.advertisingView = [YDTAdvertisingView initWithType:A8AdvertisingViewTypeLargeImage];
    [self.contentView addSubview:self.advertisingView];
}

-(void)updateSubViewsConstraintsIfNeeded{
    [self.advertisingView updateSubViewsConstraintsIfNeeded];
}
#pragma mark - Actions
